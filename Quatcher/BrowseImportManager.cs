...
namespace Quatcher
{
    ...
    public class BrowseImportManager
    {
        ...
        /// <summary>
        /// Opens a browse dialog that has filters for all files supported by Quatcher.
        ...
        public async Task ShowAllItemsBrowse()
        {
            ...
            // Add a filter for any file type that Quatcher supports
        ...
        /// Throws an exception if the file cannot be installed by Quatcher.
        /// </summary>
