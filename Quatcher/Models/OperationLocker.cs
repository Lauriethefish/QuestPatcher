...
namespace Quatcher.Models
{
    ...
    /// 
    /// This could be implemented as part of QuatcherService, however I'd prefer to keep it separate, since this class is more oriented around the current UI, and other implementators can just create their own.
    /// </summary>
