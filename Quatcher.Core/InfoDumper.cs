...
{
    /// <summary>
    /// Used to create a ZIP file containing a bunch of info about the current state of Quatcher and mods.
    /// </summary>
    public class InfoDumper
    {
        ...
        /// <summary>
        /// Creates a dump ZIP containing lots of information about the current state of Quatcher.
        ...
        public async Task<string> CreateInfoDump(string? overrideLocation = null)
        {
            ...
            try { await SaveQuatcherLogs(dumpArchive); }
            catch (Exception ex) { _logger.Warning($"Failed to save Quatcher logs to dump: {ex}"); }
        ...
        /// <summary>
        /// Saves Quatcher (and ADB) logs to the given dump.
        /// </summary>
        /// <param name="dump">The dump to save to</param>
        private async Task SaveQuatcherLogs(ZipArchive dump)
        {
        ...
        private async Task SaveConfig(ZipArchive dump)
        {
            ...
            await dump.AddFileAsync(_configManager.ConfigPath, "configs/Quatcher_config.json");
        }
        ...
        private async Task SaveInfoFile(ZipArchive dump)
        {
            ...
            await writer.WriteLineAsync("Quatcher Information dump");
