...
namespace Quatcher.Core
{
    ...
    /// <summary>
    /// Manages the downloading and verification of external files that Quatcher needs.
...
#nullable disable
            /// <summary>
            /// Range of Quatcher versions supported by this set
            /// </summary>
            [JsonIgnore]
...
#nullable enable
        ...
        /// </summary>
        private const string DownloadsUrl = "https://raw.githubusercontent.com/Lauriethefish/Quatcher/main/Quatcher.Core/Resources/file-downloads.json";
        ...
        /// <exception cref="Exception">If no download URLs were found for the current Quatcher version</exception>
        private async Task<Dictionary<ExternalFileType, SystemSpecificValue<string>>> PrepareDownloadUrls()
        {
            ...
            SemVer.Version qpVersion = VersionUtil.QuatcherVersion;
            ...
            throw new Exception($"Unable to find download URLs suitable for this Quatcher version ({qpVersion})");
        }
        ...
        private List<DownloadSet> LoadDownloadSetsFromResources()
        {
            ...
            using Stream? stream = assembly.GetManifestResourceStream("Quatcher.Core.Resources.file-downloads.json");
            if (stream == null)
            {
        ...
        /// <summary>
        /// Loads the available download sets from the Quatcher repository
        /// </summary>
